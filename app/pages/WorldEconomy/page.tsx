...
import FeaturedWorldEconomy from './FeaturedWorldEconomy'

export const metadata: Metadata = {
    title: 'iTruth News World Economy - Latest Economic Reports, Analyses, and Insights',
